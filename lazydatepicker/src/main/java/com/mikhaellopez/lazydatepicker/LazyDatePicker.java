...
public class LazyDatePicker extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        textColor = 0xff132226;
        hintColor = 0xffa4978e;
                ...
                public void onTextChanged(CharSequence s, int start, int before, int count) {
                    if (!shakeAnimationDoing) {
                        if (before > 0) {
                            ...
                            Log.v("more", "LazyDatePicker, 3");
                            // Toast.makeText(getContext(), "shakeView()", Toast.LENGTH_SHORT).show();
                            shakeView(layoutLazyDatePicker);
                        }
                        Log.v("more", "LazyDatePicker, 4");
                        showDate(date, true);
                    }
                }
    ...
    private void showKeyboard(Context context) {
        ...
        onDatePickListener.onShowKeyboard();
    }
    //endregion
